...
public final class UsbCameraRecorderActivity extends BaseActivity
        implements CameraDialog.CameraDialogParent {

    private static final boolean DEBUG = true;	// TODO set false on release
    private static final String TAG = "UsbCameraRecorderActivity";
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usbcamera_recorder);
                ...
                if (mCameraHandler.isOpened()) {
                    if (checkPermissionWriteExternalStorage() && checkPermissionAudio()) {
                        if (!mCameraHandler.isRecording()) {
                            ...
                            intentResult.putExtra("video_uri", ""); // TODO récupérer le chemin
        ...
        public void onCheckedChanged(
            ...
            if (compoundButton.getId() == R.id.camera_button) {
                    if (isChecked && !mCameraHandler.isOpened()) {
                        CameraDialog.showDialog(UsbCameraRecorderActivity.this);
                    } else {
                        stopPreview();
                    }
            }
    ...
    private final OnDeviceConnectListener mOnDeviceConnectListener
        ...
        public void onAttach(final UsbDevice device) {
            Toast.makeText(UsbCameraRecorderActivity.this,
        ...
        public void onDisconnect(final UsbDevice device,
            ...
            if (mCameraHandler != null) {
                ...
                updateItems();
                // On averti l'appelant côté ionic que la caméra a été deconnecté
